...
SESSION_ID = "test_error_repro_v2"
...
def reproduce_error():
    ...
    try: print("Upload JSON:", res.json())
    except: print("Upload Text:", res.text[:200])
    ...
    try: print("Train JSON:", res.json())
    except: print("Train Text:", res.text[:200])
